...
#line 135 "SOURCE\MAIN.H" /1
 
 
 
 
#line 139 "SOURCE\MAIN.H" /0
...
#line 11 "source\uart.c" /0
 ...
 if((uint32_t)(clock_ticks - tickstart) > Timeout){
 break;
 }
